                ...
                <section className="py-12 bg-white">
                    <div className="container mx-auto px-6 text-center">
                        <div className="max-w-3xl mx-auto bg-background-light p-8 rounded-lg">
                            ...
                            <Link href="/recursos/politica-de-dado" className="inline-block bg-transparent text-royal-blue py-3 px-8 rounded-full font-bold border-2 border-royal-blue transition-all duration-300 hover:bg-royal-blue hover:text-white">
