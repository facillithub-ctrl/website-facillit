...
export default function AvailableTestCard({ test, onStart }: Props) {
    ...
    return (
        <div className="glass-card flex flex-col p-5">
            <div className="flex justify-between items-start">
                <h3 className="text-lg font-bold text-dark-text dark:text-white mb-2">{test.title}</h3>
            ...
            <div className="text-xs text-dark-text-muted space-x-4 mb-4">
            ...
            <div className="flex justify-between items-center border-t border-white/10 pt-4">
             ...
             <button className="w-full text-center mt-3 text-sm text-dark-text-muted hover:underline">
                Ver Detalhes
            </button>
        </div>
    );
