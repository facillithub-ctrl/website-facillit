      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8 text-left py-10 border-y border-gray-700">
          <div className="col-span-2 sm:col-span-3 md:col-span-1 flex justify-center md:justify-start mb-8 md:mb-0">
             <Image src="/assets/images/LOGO/png/isologo.png" alt="Facillit Hub Isologo" width={150} height={150} />
          </div>

          <div>
            <h5 className="font-bold text-gray-400 uppercase tracking-wider text-sm mb-4">Módulos</h5>
          ...
          <div>
           ...
           <div>
            ...
            <ul className="space-y-3">
               ...
               <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Central de Ajuda</Link></li>
               <li><Link href="#" className="text-gray-300 hover:text-white transition-colors">Comunidade</Link></li>
            </ul>
          </div>
        </div>
